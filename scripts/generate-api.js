...
checklistFiles.forEach(checklistFile => {
    ...
    try {
        ...
        // wrap content in an always updating container
        const newChecklistIndexContent = {
            dateGenerated: new Date(),
            comment: 'This file was generated by the generate-api script',
            data: checklistIndexContent,
        }

        // write contents out into new output file
        new shell.ShellString(
            JSON.stringify(
                newChecklistIndexContent,
                null,
                2
            )
